...
void FUN_0059e8f8(uint *param_1) {
  ...
  switch ((uVar6 << 0x1a) >> 0x1c) {
    case 0:
      ...
      if ((iVar7 == 0) ||
          (iVar7 =
               FUN_0059faf4((uint) * (byte *)((int)param_1 + 0x13),
                            (uint)(byte)param_1[5],
                            (uint) * (byte *)((int)param_1 + 0x12)),
           iVar7 != -1)) {
        *(byte *)((int)param_1 + 0xd) =
            *(byte *)((int)param_1 + 0xd) & 0xc3 | 8;
        bVar5 = FUN_002fc8bc();
        if (bVar5) {
          bVar3 = FUN_00305f6c();
      ...
      iVar7 = FUN_0059fcfc(
          (byte)param_1[3] >> 2, *(undefined1 *)((int)param_1 + 0x13),
          (byte)param_1[5], *(byte *)((int)param_1 + 0x12), 1);
      if (iVar7 == -1) {
        *(byte *)((int)param_1 + 0xd) =
            *(byte *)((int)param_1 + 0xd) & 0xc3 | 8;
        bVar5 = FUN_002fc8bc();
      ...
      LAB_0059ed9c:
        uVar1 =
            ((uint) * (byte *)((int)param_1 + 0xe) << 0x1b) >> 0x1d;
        if (uVar1 != 1) {
    ...
    case 2:
      *(undefined1 *)(DAT_0059eb34 + (uVar6 & 3) * 0x12 + 0xf) = 3;
      return;
    case 3:
      FUN_005a16b0((byte)param_1[3] >> 2, (byte)param_1[3] & 3,
                   (undefined2 *)param_1, (undefined2 *)(param_1 + 1),
    ...
    case 9:
      ...
      break;
    case 6:
      iVar7 = FUN_0059faf4((uint) * (byte *)((int)param_1 + 0x13),
                           (uint)(byte)param_1[5],
                           (uint) * (byte *)((int)param_1 + 0x12));
      if (iVar7 == -1) {
        return;
      ...
      *(undefined1 *)(iVar7 + 3) = 1;
      do {
        ...
        if (bVar5) {
          *(byte *)(iVar7 + 3) =
              *(byte *)(iVar7 + 3) | (byte)(1 << (uVar6 & 0xff));
        }
        uVar6 = uVar6 + 1;
      } while (uVar6 < 4);
      bVar4 = *(byte *)(iVar7 + 4);
      if (bVar4 != 0x17) {
        if (bVar4 < 0x18) {
          if ((bVar4 != 2 && bVar4 != 4) &&
              (bVar4 != 5 && bVar4 != 0x15))
            goto LAB_0059eacc;
        } else if ((bVar4 != 0x18 && bVar4 != 0x19) && bVar4 != 0x1a)
          goto LAB_0059eacc;
      }
    ...
    case 8:
      FUN_0059fcfc(
          (byte)param_1[3] >> 2, *(undefined1 *)((int)param_1 + 0x13),
          (char)param_1[5], *(undefined1 *)((int)param_1 + 0x12), 0);
      return;
    default:
      return;
  }
