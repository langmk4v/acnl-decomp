...
#include "002/002f75cc.c"
#include "003/00305f6c.c"

void FUN_0059ebe8(undefined2 *param_1,undefined2 *param_2,byte param_3)
{
  byte bVar1;
  byte bVar2;
  byte bVar3;
  ...
  *(byte *)((int)param_1 + 0xd) = (param_3 & 0xf) << 2 | bVar1 & 0xc0 | bVar2 & 3;
